...
(use-package auto-dark
  :straight t
  :custom
  (auto-dark-themes '(ef-frost ef-winter))
  :config
...
This is intended to fix theme rendering issues on new emacsclient frames."
    (let* (;; Safely try to determine if the system is in dark mode.
           ...
           (light-theme-name (car auto-dark-themes))    ; Get the light theme name from your custom setting
           (dark-theme-name (cadr auto-dark-themes))    ; Get the dark theme name
